      ...
      <div className=" flex-1 pr-10">
        ...
        <div className="h-screen absolute mt-10 items-center justify-center pl-10">
          ...
          <p className="text-[#626262] mt-4">
            ...
            connect, share information, and engage with the world. While social
            media has undoubtedly transformed various aspects of society, its
            influence on politics and political discourse is a topic that
            warrants careful analysis and exploration.
          </p>
        </div>
      </div>
    </div>
